...
class Registros extends Component
{
	...
	public function generarPDF($mesSeleccionado = null, $anioSeleccionado = null, $institutoSeleccionado = null, $keyWord = null)
	{
		...
		$html = view('livewire.registros.pdf', compact('registros', 'institutoSeleccionado', 'mesSeleccionado', 'anioSeleccionado', 'institutoCuentaCorriente', 'saldoAnterior', 'currentDateTime', 'currentURL'))->render();
		// Agregar título personalizado al HTML
		$title = $institutoSeleccionado . '_' . $anioSeleccionado . '_' . $mesSeleccionado;
		...
		$filename = $institutoSeleccionado.'_'.$anioSeleccionado.'_'.$mesSeleccionado.'.pdf';
